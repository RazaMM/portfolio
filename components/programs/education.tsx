...
const Education: React.FC = () => {
  return (
    <div className='flex h-full w-full flex-col items-center gap-4 border-[2rem] border-degree-red bg-degree-beige p-2 text-center sm:max-h-fit sm:max-w-[35rem] md:border-[3rem]'>
